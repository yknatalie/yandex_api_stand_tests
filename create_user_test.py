...
def test_create_user_english_letter_in_first_name_get_success_responce():
    positive_assert("Asdrf")

def test_create_user_russian_letter_in_first_name_get_success_response():
    positive_assert("Маша")
...
def test_create_user_no_first_name_get_error_response():
    negative_assert_symbol({"phone": "+79995553322", "address": "г. Москва, ул. Пушкина, д. 10"})

def test_create_user_empty_parameter_get_error_response():
    user_body = data.user_body.copy()
    user_body["firstName"] = ""
    negative_assert_no_first_name(user_body)

def test_create_user_number_type_get_error_response():
